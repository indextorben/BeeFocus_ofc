...
struct MacStatistikView: View {
    ...
    var storeItems: [StoreItem] {[
        StoreItem(name: "Ocean",           icon: "water.waves",              kosten: 500,   farbe: .cyan,                                    beschreibung: "Ruhige Wellen, tiefes Blau"),
        StoreItem(name: "Forest",          icon: "leaf.fill",                kosten: 750,   farbe: .green,                                   beschreibung: "Frische Natur, lebendiges Grün"),
        StoreItem(name: "Ice",             icon: "snowflake",                kosten: 800,   farbe: Color(red: 0.6, green: 0.9, blue: 1.0),   beschreibung: "Kühle Stille, kristallklares Weiß"),
        StoreItem(name: "Autumn",          icon: "wind",                     kosten: 900,   farbe: Color(red: 0.8, green: 0.4, blue: 0.1),   beschreibung: "Warme Töne, goldenes Laub"),
        StoreItem(name: "Night",           icon: "moon.stars.fill",          kosten: 1000,  farbe: .indigo,                                  beschreibung: "Samtene Dunkelheit, funkelnde Sterne"),
        StoreItem(name: "Lavender",        icon: "sparkles",                 kosten: 1200,  farbe: .purple,                                  beschreibung: "Sanftes Violett, duftende Felder"),
        StoreItem(name: "Solar",           icon: "sun.max.fill",             kosten: 1500,  farbe: .orange,                                  beschreibung: "Energie der Sonne, strahlend warm"),
        StoreItem(name: "Sunset",          icon: "sunset.fill",              kosten: 1800,  farbe: Color(red: 1.0, green: 0.4, blue: 0.2),   beschreibung: "Glühendes Abendhimmel-Orange"),
        StoreItem(name: "Cherry Blossom", icon: "camera.macro",              kosten: 2000,  farbe: .pink,                                    beschreibung: "Zarte Blüten, japanisches Frühjahr"),
        StoreItem(name: "Northern Lights", icon: "aqi.medium",               kosten: 2500,  farbe: Color(red: 0.0, green: 0.8, blue: 0.6),   beschreibung: "Magisches Aurora-Spektakel"),
        StoreItem(name: "Volcano",         icon: "flame.fill",               kosten: 3000,  farbe: .red,                                     beschreibung: "Brennende Intensität, pure Kraft"),
        StoreItem(name: "Galaxy",          icon: "moon.circle.fill",         kosten: 5000,  farbe: Color(red: 0.4, green: 0.2, blue: 1.0),   beschreibung: "Endloses Universum, kosmische Tiefe"),
